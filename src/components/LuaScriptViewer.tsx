...
export function LuaScriptViewer() {
  const [copied, setCopied] = useState(false);

  const luaScript = `-- Roblox Script Loader with Key System
    ...
    <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
      <div className="flex items-center justify-between mb-4">
        <div className="flex items-center gap-2">
          ...
          <h2 className="text-xl font-bold text-gray-900">Roblox Loader Script</h2>
        </div>
      ...
      <div className="bg-gray-900 rounded-lg p-4 overflow-x-auto max-h-96 overflow-y-auto">
        <pre className="text-sm text-green-400 font-mono">{luaScript}</pre>
      </div>

      <div className="mt-4 p-4 bg-yellow-50 border border-yellow-200 rounded-lg">
        <h3 className="font-semibold text-yellow-900 mb-2 text-sm">Penting:</h3>
        <ul className="text-xs text-yellow-800 space-y-1 list-disc list-inside">
          <li>Ganti <code className="bg-yellow-100 px-1 rounded">YOUR_SUPABASE_URL</code> dengan URL Supabase Anda</li>
          <li>Ganti <code className="bg-yellow-100 px-1 rounded">YOUR_WEBSITE_URL</code> dengan URL website Anda</li>
          <li>Ganti <code className="bg-yellow-100 px-1 rounded">YOUR_KEY_VALUE</code> dengan key value yang spesifik</li>
          <li>Script ini akan menampilkan UI key system di Roblox</li>
          <li>User harus mendapatkan key dari website Anda terlebih dahulu</li>
        </ul>
      </div>
    </div>
  );
